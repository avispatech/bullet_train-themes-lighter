...
class CustomThemeFileReplacerTest < ActiveSupport::TestCase
  def setup
    @file_replacer = BulletTrain::Themes::Lighter::CustomThemeFileReplacer.new("foo")
  end

  test "default_files_to_replace returns proper files" do
    default_files = [
      "./local/bullet_train-themes-foo/bullet_train-themes-lighter.gemspec",
    ...
    assert_equal @file_replacer.default_files_to_replace("lighter"), default_files
  end
  ...
  test "build_main_app_file_name returns file name that exists in the main app" do
    ...
    custom_gem_file = "./app/javascript/application.lighter.js"
