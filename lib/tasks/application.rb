  ...
  module Themes
    module Application
      ...
      def self.release_theme(original_theme_name, args)
        ...
        `git clone git@github.com:avispatech/bullet_train-themes-lighter.git ./local/bullet_train-themes-#{args[:theme_name]}`

        custom_file_replacer = BulletTrain::Themes::Lighter::CustomThemeFileReplacer.new(args[:theme_name])
        custom_file_replacer.replace_theme("lighter", args[:theme_name])
