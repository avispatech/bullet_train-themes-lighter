  ...
  module Themes
    module Lighterer
      class CustomThemeFileReplacer
        ...
        include BulletTrain::Themes::Lighter::FileReplacer
        ...
        def replace_theme(original_theme, custom_theme)
          ...
          files_to_replace.each do |custom_gem_file|
            ...
            begin
              if custom_gem_file[:must_compare] && !BulletTrain::Themes::Lighter::FileReplacer.files_have_same_content?(custom_gem_file[:file_name], main_app_file)
                BulletTrain::Themes::Lighter::FileReplacer.replace_content(old: custom_gem_file[:file_name], new: main_app_file)
              end
          ...
          # i.e. - `module Lighter` and `tailwind.light.config`.
